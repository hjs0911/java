...
public interface BoardDao {
	...
	int deleteTBoard(Board board) throws Exception;
	...
	int backNum(Board board) throws Exception;
	int nextNum(Board board) throws Exception;
	...
	int deleteTComment(Board board) throws Exception;

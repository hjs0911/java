...
public class MySqlBoardDao implements BoardDao {
	...
	@Override
	public int backNum(Board board) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			return sqlSession.selectOne(
					"kr.pe.temp.pension.dao.BoardDao.backNum", board);
		} finally {
			sqlSession.close();
		}
	}
	...
	@Override
	public int nextNum(Board board) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			return sqlSession.selectOne(
					"kr.pe.temp.pension.dao.BoardDao.nextNum", board);
		} finally {
			sqlSession.close();
		}
	}
	...
	@Override
	public int deleteTBoard(Board board) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			int result = sqlSession.delete("kr.pe.temp.pension.dao.BoardDao.deleteTBoard", board); 
			if(result > 0) sqlSession.commit();
			return result;
		} finally {
			sqlSession.close();
	...
	@Override
	public int deleteTComment(Board board) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			int result = sqlSession.delete("kr.pe.temp.pension.dao.BoardDao.deleteTComment", board); 
			if(result > 0) sqlSession.commit();
			return result;
		} finally {
			sqlSession.close();

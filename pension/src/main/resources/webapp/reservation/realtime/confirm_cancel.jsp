	...
	<div class="container">
				...
				<table class="table">
					...
					<tr>
						...
						<td bgcolor="white" width="80%" align="left" height="40">${resveRoom.stayBeginDay.year + 1900}년
							${resveRoom.stayBeginDay.month + 1}월 ${resveRoom.stayBeginDay.date}일
							~ ${resveRoom.stayEndDay.year + 1900}년 ${resveRoom.stayEndDay.month + 1}월
							${resveRoom.stayEndDay.date}일 (${resveRoom.resvePd }박
							${resveRoom.resvePd + 1}일)</td>
					</tr>
					<tr>
		...
		<table class="table">
			<tr>
				<td>
					<p align="center">
						<input type="button" value="예약완료" id="btn_resve4">&nbsp;<input
							type="button" value="예약취소" id="cancel">
					</p>
				</td>
			</tr>
		</table>

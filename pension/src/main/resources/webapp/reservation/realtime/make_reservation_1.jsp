		...
		<div class="container-fluid">
			...
			<form action="make_reservation_2.temp" method="post" id="make1">
				<form class="form-inline">
					<div class="form-group">
						<table class="table" border="0" cellpadding="15" cellspacing="1"
							align="center">
							<tr bgcolor="#F7F6F6">
								<td width="66%" align="left"><font color="#333333">
										<div class="row">
											<div class="col-xs-2">
												<INPUT name="sYear" class="form-control"
													value="${sDate.year +1900}" maxLength=4 size=5>년
									...
									<div class="col-xs-2">
										<SELECT name="sPeriod" id="period" class="form-control">
				...
				<table class="table" style="text-align: center;">
					<tr>
						...
						<td width="100%" align="left" colspan=2>※ 주문 : <br>그릴서비스
							...
							</div> SET&nbsp;&nbsp;&nbsp; - <span id="addNum">0</span> SET : <span
				...
				<table class="table">
					<tr>
						<td>
							<table border="0">
								<tr>
									<td height="50"><font color="#666666"><b>※
												유의사항및 약관, 환불기준</b></font></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left"><P>
											* 스파이용시 거품목욕제, 기타입욕제를 사용하실 수 없습니다. (고장의 원인이며 사용불가 상태가 됩니다.) <BR>*
											...
											LDE 티라이트 이외의 인화성 초 사용금지 <BR>* 애완동물은 고객님의 편안한 휴식을 위하여 입실
											할 수 없습니다. <BR>* 미성년자는 보호자 없이 투숙이 불가합니다.<br> * 객실
											내에서는 금연이며, 기름을 많이 요하는 음식의 조리를 피해주시기 바랍니다. <BR>* 타 객실손님들을
											배려하여 고성방가를 자제해 주시기 바랍니다.<BR>* 최대 수용인원을 초과 할 수 없습니다. <BR>*
											주말이나 성수기, 연휴기간에는 미리 예약을 해주세요 <BR>* 입금자명은 예약자 이름과 동일하게
											해주시기 바랍니다.
										</P>
										<P>
											<STRONG><FONT style="COLOR: #0000ff">(만일, 위
													같은 이유로 예약이 되지 않을시 펜션측은 책임지지 않으니 반드시 유의해주시기 바랍니다.)</FONT></STRONG>
										</P></td>
								</tr>
								<tr>
									<td height="30">&nbsp;</td>
								...
								<tr>
									<td align="left"><P>* 올바른 예약문화 정착을 위하여 저희 펜션에는 예약취소시
										...
										<P>
											<STRONG>*<FONT style="COLOR: #ff0000">예약 후
													취소시</FONT>에는 <FONT style="COLOR: #ff0000">기본 10%의 위약금</FONT>이
												있습니다.
											</STRONG>
										</P>
				...
				<table class="table" border="0" cellpadding="15" cellspacing="1"
					align="center">
					<tr>
						<td height="30"><input type="checkbox" class="dongui"
							value="Y"> <font color="blue"> 위 <b>유의사항및 약관</b>과
								환불기준에 동의하시면 체크하신후 다음단계로 진행해 주세요!
						</font><br></td>
					</tr>
					<tr>
						<td><p>&nbsp;</p></td>

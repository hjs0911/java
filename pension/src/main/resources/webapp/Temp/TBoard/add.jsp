		...
		<div class="container-fluid text-center">
			...
			<div class="container">
				<div class="col-sm-10 text-center sidecontents">
					<form class="form-horizontal" role="form" id="galleryForm"
						name="boardForm" method="post" action="add.temp"
						...
						<div class="form-group" style="margin-top: 20px">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" name="bname" id="bname" value="관리자">
								</div>
								<label class="col-sm-2 control-label">비밀번호:</label>
								<div class="col-sm-4">
									<input type="password" class="form-control" id="dpwd"
										name="dpwd">
								</div>
							</div>
							...
							<div class="btn-right">
								<input type="submit" class="btn-primary" value="등록"> <input
									type="button" class="btn-primary" value="취소"
									onclick="location.href='list.temp?type=${type}&currentPage=${currentPage}'">
							</div>
							<input type="hidden" id="bsection" name="bsection"
								value="${type}">
						</div>
					</form>
				</div>

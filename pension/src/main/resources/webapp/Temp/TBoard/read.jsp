	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="container ol-sm-10 text-center sidecontents">
				...
				<!-- 댓글 -->
				<form action=coDel.temp " method="post" id="TCoDel">
					<input type="hidden" name="num" value="${board.num}"> <input
						...
						<input type="hidden" name="cnum" value="${board.cnum}">
				</form>
										...
										<c:forEach begin="0" end="9" varStatus="no"
											...
											<tr>
												...
												<td><a href="#" data-toggle="modal"
													...
													class="udt">수정</a> | <a href="#" data-cnum="${board.cnum }"
													class="del">삭제</a></td>
											</tr>
										</c:forEach>
									</table>
				...
				<form action="TDelete.temp" id="TDel" method="post">
					<input type="hidden" name="num" value="${board.num}"> <input
						type="hidden" name="type" value="${type}">
				</form>
				<form action="update.temp" id="TUdt" method="post">
					<input type="hidden" name="num" value="${board.num}"> <input
						type="hidden" name="type" value="${type}"> <input
						type="hidden" name="currentPage" value="${currentPage}">
				</form>
				...
				<div class="btn-right">
					<input type="button" class="btn-primary" value="수정" id="TUdtOk">
					<input type="button" class="btn-primary" value="삭제" id="TDelOk">
					<input type="button" class="btn-primary" value="돌아가기"
						onclick="location.href='list.temp?type=${type}&currentPage=${currentPage}'">
				</div>

				<div class="btn" style="float: left;">
					<form action="nextNum.temp" id="next">
						<button class="btn-primary next" value="next">다음 글</button>
						<button class="btn-primary next" value="back">이전 글</button>
						<input type="hidden" name="num" value="${board.num}"> <input
							type="hidden" name="type" value="${type}"> <input
							type="hidden" name="next" value=""> <input type="hidden"
	...
	<script>
		$(document).ready(
				function() {
					...
					$("#TDelOk").click(function() {
						$("#TDel").submit();
						alert("삭제되었습니다.");
					});
					$("#TUdtOk").click(function() {
						$("#TUdt").submit();
					});
					$(".del").click(function() {

		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<c:if test="${fn:contains(pageContext.request.requestURI, 'TPw')}">
						<c:set var="pw" value="active"/>
					</c:if>
					...
					<li class="dropdown ${board }">
						...
						<ul class="dropdown-menu">
							<li><a href="${pageContext.servletContext.contextPath}/Temp/TBoard/list.temp?type=N">Notice</a></li>
							<li><a href="${pageContext.servletContext.contextPath}/Temp/TBoard/list.temp?type=Q">FAQ</a></li>
							<li><a href="${pageContext.servletContext.contextPath}/Temp/TBoard/list.temp?type=E">Reviews</a></li>
						</ul>
					</li>
					...
					<li class="${pw }"><a href="${pageContext.servletContext.contextPath}/Temp/TPw/infoForm.temp">Login Info</a></li>
				</ul>
